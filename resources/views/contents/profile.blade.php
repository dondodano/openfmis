    ...
    <div class="h-full w-full pb-6 bg-base-100">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-control w-full undefined">
                ...
                <input type="text" placeholder="" class="input  input-bordered w-full " value="alex@dashwind.com">
            </div>
            <div class="form-control w-full undefined">
                <label class="label">
                    <span class="label-text text-base-content undefined">Title</span>
                </label>
                <input type="text" placeholder="" class="input  input-bordered w-full " value="UI/UX Designer">
            </div>
            <div class="form-control w-full undefined">
                <label class="label">
                    <span class="label-text text-base-content undefined">Place</span>
                </label>
                <input type="text" placeholder="" class="input  input-bordered w-full " value="California">
            </div>
            <div class="form-control w-full undefined">
                <label class="label">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-control w-full undefined">
                ...
                <input type="text" placeholder="" class="input  input-bordered w-full " value="English">
            </div>
            <div class="form-control w-full undefined">
                <label class="label">
                    <span class="label-text text-base-content undefined">Timezone</span>
                </label>
                <input type="text" placeholder="" class="input  input-bordered w-full " value="IST">
            </div>
            <div class="form-control w-full undefined">
